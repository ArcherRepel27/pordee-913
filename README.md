...
```bash
git clone https://github.com/ArcherRepel27/pordee-913.git
cd pordee-913
npm install
npm start
```
...
ได้แรงบันดาลใจมาจาก [caveman](https://github.com/ArcherRepel27/pordee-913) — pordee เป็นรุ่นภาษาไทยที่ตัด token ทิ้งโดยไม่เสียความถูกต้องทาง technical
...
<!-- Last updated: 2026-06-06 15:42:19 -->
